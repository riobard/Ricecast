...
MPEGHeader  = namedtuple('MPEGHeader', ' '.join([
...
def parse_header(header):
    ...
    bitrate             = MPEG_BITRATE[version_index][layer_index][bitrate_index]
    ...
    samplingrate        = MPEG_SAMPLINGRATE[version_index][samplingrate_index]
...
class Framer(object):
    ...
    def parse_frame(self, chunk):
        ...
        while i != -1:      # check all \xff
            header  = parse_header(chunk[i:i+4])
